          ...
          <ol className="timeline-list">
            <li className="timeline-item">
              ...
              <p className="timeline-text">
                ...
                understanding both the theory and practical aspects of
                computing. This involves programming fundamentals, computer
                architecture, operating systems, databases, software
                engineering, problem solving, collaboration and communication
                soft skills.
              </p>
            </li>
            ...
            <li className="timeline-item">
              ...
              <p className="timeline-text">
                ...
                technologies, user interface designs and content management
                systems.
              </p>
            </li>
          </ol>
        ...
        <section className="timeline">
          ...
          <ol className="timeline-list">
            ...
            <li className="timeline-item">
              ...
              <span>2013 - 2015</span>
              <p className="timeline-text">
                I create and develop visual concepts that align with the
                projects goals and objectives, supervising the design process
                and managing timelines and budgets for design projects.
              </p>
            </li>
            ...
            <li className="timeline-item">
              ...
              <span>2010 - 2013</span>
              <p className="timeline-text">
                I create logos, color schemes and typography for a brands
